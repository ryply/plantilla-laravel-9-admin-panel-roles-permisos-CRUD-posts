...
class PostPolicy
{
    ...
    // Con este metodo el usuario con role admin tiene acceso a todas las autorizaciones
     ...
     * Determinar si la usuario puede ver algún modelo.
     *
     ...
     * Determinar si la usuario puede ver el modelo.
     *
     * @param  \App\Models\User  $user
    ...
    {
        // Si el rol del usuario tiene el permiso 'craete post' (retornamos true)
     ...
     * Determine si el usuario puede eliminar el modelo de forma permanente.
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Post  $post
     * @return \Illuminate\Auth\Access\Response|bool
